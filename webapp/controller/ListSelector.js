sap.ui.define([
		...
		return BaseObject.extend("howdensPO.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias howdensPO.model.ListSelector
			 */
			 ...
			 * @return {howdensPO.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
